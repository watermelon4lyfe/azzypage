...
<head>
    ...
    <title>Azzy Khanzada's Personal Webpage</title>
    <style>
        body {
        ...
        .star-1 { top: 10px; left: 10px; }
        .star-2 { top: 10px; right: 10px; }
        .star-3 { bottom: 10px; left: 10px; }
        .star-4 { bottom: 10px; right: 10px; }
